...
{
    public abstract class LMS_BackendWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LMS_BackendWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LMS_BackendWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LMS_BackendDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LMS_BackendDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LMS_BackendDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LMS_BackendDbContext, Task<T>> func)
        {
            T result;
