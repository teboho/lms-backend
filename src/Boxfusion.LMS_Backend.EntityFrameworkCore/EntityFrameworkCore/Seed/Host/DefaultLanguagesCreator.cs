...
namespace Boxfusion.LMS_Backend.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LMS_BackendConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LMS_BackendDbContext context)
        {
            _context = context;
        }
